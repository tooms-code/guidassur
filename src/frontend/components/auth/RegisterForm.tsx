...
import { passwordRequirements, passwordRegex } from "@/frontend/lib/passwordValidation";
...
const registerSchema = z
  .object({
    ...
    password: z
      ...
      .regex(passwordRegex.lowercase, "Doit contenir une minuscule")
      .regex(passwordRegex.uppercase, "Doit contenir une majuscule")
      .regex(passwordRegex.number, "Doit contenir un chiffre")
      .regex(passwordRegex.special, "Doit contenir un caractère spécial"),
